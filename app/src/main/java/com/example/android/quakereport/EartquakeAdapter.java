...
public class EartquakeAdapter extends ArrayAdapter<Earthquake> {
    ...
    String url;
    public EartquakeAdapter(EarthquakeActivity context, ArrayList<Earthquake> element) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // Find the TextView in the list_element.xml layout with the ID version_name
        TextView mag = (TextView) listItemView.findViewById(R.id.mag);
        // Format the magnitude to show 1 decimal place
        String formattedMagnitude = formatMagnitude(earthquake.getMga());
        ...
        int magnitudeColor = getMagnitudeColor(earthquake.getMga());
        ...
        /*spilt the string into to parts */
    ...
    /* return the proper color based on the value of magunitude*/
